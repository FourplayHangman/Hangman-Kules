...
#code to import the packages to display the image of the hanging turtle
#the image shows up after the first incorrect guess in a new window
#the player has to manually close the window to continue the code
...
#group created a dictionary to provide the words for the game
#we could have included an infinite number of terms, but it will not change the code any
